...
const MODULOS=['nav-core','gpx-core','restrictions-core','street-match-core','streetview-core',
 'coverage-core','start-core','route-store-core','diagnostico-core',
 ...
 'layout-audit-core','street-imagery-core','sol-core','llegada-core'];
const FICHEROS=['access','checklist','corridor','coverage','diagnostico','fuentes','gpx','hud','layout-audit','library','llegada','marks',
 'navigation','overlay','pace','power','recovery','restrictions','shim','sim','sol','street-imagery',
