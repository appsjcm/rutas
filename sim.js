...
panel.innerHTML=
 ...
 +'<button type="button" data-p="lento"><svg class="ui-icon ico-boton" viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 16.5a8 8 0 1 1 15 0"/><path d="M12 14l-4.2-3.6"/></svg>Lento</button>'
 +'<button type="button" data-p="normal">Normal</button>'
 +'<button type="button" data-p="rapido"><svg class="ui-icon ico-boton" viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 16.5a8 8 0 1 1 15 0"/><path d="M12 14l4.2-3.6"/></svg>Rápido</button>'
 +'</span></label>'
 +'</div>'
