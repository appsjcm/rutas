const VERSION='rutas-shell-clean-nav-v13',TILES='rutas-tiles-v1',FONTS='rutas-fonts-v1',TILE_CAP=1500;
const SHELL=['./','index.html','navigation.css','premium.css','premium.js','map3d.js','map3d.css','approach.js','approach.css','library.js','library.css','gps-setup.js','gps-setup.css','access-core.js','access.js','gpx-core.js','vendor/maplibre-gl.js','vendor/maplibre-gl.css','nav-core.js','restrictions-core.js','navigation.js','restrictions.js','manifest.webmanifest','icon-192.png','icon-512.png','vendor/leaflet.js','vendor/leaflet.css'];
