const VERSION='rutas-llegada-v201',TILES='rutas-tiles-v2',FONTS='rutas-fonts-v2',TILE_CAP=1500;
const SHELL=['./','index.html','navigation.css','premium.css','sol-core.js','premium.js','simmode.js','map3d.js','map3d.css','streetview-core.js','streetview.js','streetview.css','approach.js','approach.css','library-core.js','library.js','library.css','gps-setup.js','gps-setup.css','street-match-core.js','street-match.js','street-match.css','segments.js','sim-core.js','sim.js','vehicle-core.js','vehicle.js','vehicle.css','checklist-core.js','checklist.js','checklist.css','recovery-core.js','landscape.css','power-core.js','power.js','power.css','hud-core.js','hud.css','marks-core.js','marks.js','marks.css','pace-core.js','pace.js','pace.css','overlay-core.js','overlays.js','overlays.css','coverage-core.js','coverage.js','coverage.css','acabado.css','voz.js','diagnostico-core.js','diagnostico.js','llegada-core.js','llegada.js','start-core.js','start.js','start.css','sim.css','layout-audit-core.js','layout-audit.js','street-imagery-core.js','street-imagery.js','street-imagery.css','segments.css','access-core.js','access.js','audit.js','gpx-core.js','vendor/maplibre-gl.js','vendor/maplibre-gl.css','nav-core.js','route-store-core.js','restrictions-core.js','navigation.js','restrictions.js','manifest.webmanifest','icon-192.png','icon-512.png','icon-maskable-512.png','apple-touch-icon.png','vendor/leaflet.js','vendor/leaflet.css'];
...
// La pagina puede preguntar que version la esta sirviendo. Sin esto, «no se actualiza en
// el movil» no hay forma de comprobarlo: se ve la misma pantalla lleve lo que lleve.
self.addEventListener('message',e=>{
 if(e.data==='skip-waiting'){self.skipWaiting();return;}
 if(e.data==='version'&&e.source)e.source.postMessage({rutasVersion:VERSION});
});
...
// Las teselas se piden con CORS y se guardan solo asi. Antes se guardaban opacas -sin CORS-, y
// el navegador apunta cada respuesta opaca como si pesara unos 7 MB para no revelar su tamaño:
// 54 teselas de 15 KB contaban 367 MB, y con las 1500 del tope serian unos 10 GB "ficticios".
// En Android eso puede hacer que el navegador borre todo lo de la aplicacion, rutas incluidas,
// para hacer sitio. Una opaca que se cuele se sirve, pero no se guarda.
