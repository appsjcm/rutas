const VERSION='rutas-shell-library-core-v22',TILES='rutas-tiles-v1',FONTS='rutas-fonts-v1',TILE_CAP=1500;
const SHELL=['./','index.html','navigation.css','premium.css','premium.js','map3d.js','map3d.css','approach.js','approach.css','library-core.js','library.js','library.css','gps-setup.js','gps-setup.css','street-match-core.js','street-match.js','street-match.css','segments.js','segments.css','access-core.js','access.js','gpx-core.js','vendor/maplibre-gl.js','vendor/maplibre-gl.css','nav-core.js','restrictions-core.js','navigation.js','restrictions.js','manifest.webmanifest','icon-192.png','icon-512.png','vendor/leaflet.js','vendor/leaflet.css'];
...
self.addEventListener('fetch',e=>{
 ...
 // El mapa 3D vive de teselas vectoriales, tipografias y sprites de otro dominio:
 // sin esta regla el 2D funcionaba sin cobertura y el 3D se quedaba en blanco.
 if(url.hostname.endsWith('tiles.openfreemap.org')){e.respondWith(tile(req));return;}
