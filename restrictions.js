...
window.RutasChecks={titleAt:d=>{const i=upcoming(d);return i?description(i):null;},gpsAlert:d=>{const i=upcoming(d);return i?'Atención. '+description(i)+'. '+i.name+'. Revisa la señalización antes de continuar.':null;}};
